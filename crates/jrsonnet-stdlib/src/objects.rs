...
#[builtin]
pub fn builtin_object_fields_ex(obj: ObjValue, hidden: bool) -> Vec<Val> {
	let out = obj.fields_ex(hidden);
	out.into_iter().map(Val::string).collect::<Vec<_>>()
}

#[builtin]
pub fn builtin_object_fields(o: ObjValue) -> Vec<Val> {
	builtin_object_fields_ex(o, false)
}

#[builtin]
pub fn builtin_object_fields_all(o: ObjValue) -> Vec<Val> {
	builtin_object_fields_ex(o, true)
}

pub fn builtin_object_values_ex(o: ObjValue, include_hidden: bool) -> ArrValue {
	o.values_ex(include_hidden)
}
#[builtin]
pub fn builtin_object_values(o: ObjValue) -> ArrValue {
	builtin_object_values_ex(o, false)
}
#[builtin]
pub fn builtin_object_values_all(o: ObjValue) -> ArrValue {
	builtin_object_values_ex(o, true)
}

pub fn builtin_object_keys_values_ex(o: ObjValue, include_hidden: bool) -> ArrValue {
	o.key_values_ex(include_hidden)
}
#[builtin]
pub fn builtin_object_keys_values(o: ObjValue) -> ArrValue {
	builtin_object_keys_values_ex(o, false)
}
#[builtin]
pub fn builtin_object_keys_values_all(o: ObjValue) -> ArrValue {
